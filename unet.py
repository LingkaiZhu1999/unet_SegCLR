...
class Unet_dropout(nn.Module):
    def __init__(self, in_channel=4, out_channel=3, dropout=True):
        ...
        self.down1 = Downsample_block(in_channel, 64, dropout)
        self.down2 = Downsample_block(64, 128, dropout)
        ...
        self.up2 = Upsample_block(256, 128, dropout)
        self.up1 = Upsample_block(128, 64, dropout)
