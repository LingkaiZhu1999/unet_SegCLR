...
def parse_args():
    ...
    parser.add_argument('--lam', default=100, type=int) # lambda 
    ...
    args.name = f'{args.domain_source}_adapt_{args.domain_target}_lambda_{args.lam}_batchsize_{args.batch_size}_{args.contrastive_mode}_{args.mode}_Cch_seed_{args.seed}'
    return args
