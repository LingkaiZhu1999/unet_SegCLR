...
def main():
    ...
    # Data loading code
    img_paths = glob('/mnt/asgard2/data/lingkai/braTS21/slice/images/*')
    mask_paths = glob('/mnt/asgard2/data/lingkai/braTS21/slice/mask/*')

    val_img_paths = img_paths[0:10]
    val_mask_paths = mask_paths[0:10]
    print(val_img_paths)
    ...
    val_dataset = BratsValidationDataset(args, val_img_paths, val_mask_paths)
